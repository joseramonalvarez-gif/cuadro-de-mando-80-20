...
export default function KpiCard({ title, value, trend, status, icon: Icon, subtitle, onClick }) {
  const statusColors = {
  ...
  return (
    ...
    >
      {/* Status indicator */}
      <div className={`absolute top-4 right-4 w-2.5 h-2.5 rounded-full ${statusColors[status] || statusColors.green}`} />
