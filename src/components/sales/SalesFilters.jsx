...
export default function SalesFilters({ filters, onFilterChange, onExport, onCreateAlert, onSaveView, isAdmin, isAdvanced }) {
  return (
    <div className="bg-white rounded-2xl p-4 shadow-[0_1px_3px_rgba(27,39,49,0.06)] border border-[#E8EEEE]/60 mb-6">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <Select value={filters.rfmSegment} onValueChange={(v) => onFilterChange({ ...filters, rfmSegment: v })}>
          ...
          <SelectContent>
            ...
            <SelectItem value="loyal">Cliente Fiel</SelectItem>
